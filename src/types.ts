...
export const ghosts: Ghost[] = [
    ...
    {
        name: 'Demon',
        evidence: [Evidence.GhostWriting, Evidence.SpiritBox, Evidence.FreezingTemps]
    },
    {
        name: 'Jinn',
    ...
    {
        name: 'Wraith',
        evidence: [Evidence.Fingerprints, Evidence.SpiritBox, Evidence.FreezingTemps]
    },
    {
        name: 'Yurei',
        evidence: [Evidence.GhostWriting, Evidence.FreezingTemps, Evidence.GhostOrb]
    }
]